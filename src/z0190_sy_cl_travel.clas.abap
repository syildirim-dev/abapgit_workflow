CLASS z0190_sy_cl_travel DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS z0190_sy_cl_travel IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.
   DATA:itab TYPE TABLE OF z0190_sy_travel.
...
*   delete existing entries in the database table
   DELETE FROM z0190_sy_travel.

*   insert the new table entries
   INSERT z0190_sy_travel FROM TABLE @itab.

*   check the result
   SELECT * FROM z0190_sy_travel INTO TABLE @itab.
   out->write( sy-dbcnt ).
