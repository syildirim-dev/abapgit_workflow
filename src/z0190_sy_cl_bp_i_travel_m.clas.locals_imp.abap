...
TYPES tt_travel_update TYPE TABLE FOR UPDATE z0190_sy_m.
...
READ ENTITY z0190_sy_m\\travel FROM VALUE #(
...
MODIFY ENTITIES OF z0190_sy_m IN LOCAL MODE
       ENTITY travel
  ...
  READ ENTITIES OF z0190_sy_m IN LOCAL MODE
       ENTITY travel
...
READ ENTITY z0190_sy_m FROM VALUE #( FOR keyval IN keys
                                                  (  %key                    = keyval-%key
